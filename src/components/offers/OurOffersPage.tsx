      ...
      >
        ...
        <div className="relative z-10 max-w-7xl mx-auto w-full space-y-8">
          ...
          <div className="max-w-3xl space-y-5">
            ...
            {/* Main Title */}
            <h1 className="font-heading text-3xl sm:text-5xl lg:text-[52px] font-bold text-white tracking-tight leading-[1.15]">
          ...
          <div className="pt-2 flex flex-wrap items-center gap-3">
            <button
              ...
              className="px-5 py-3 rounded-2xl bg-white/10 hover:bg-white/20 border border-white/15 backdrop-blur-md text-white text-xs font-heading font-bold inline-flex items-center gap-2 cursor-pointer transition-all duration-200"
            >
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 pt-8 border-t border-white/15 text-start">
            <div className="space-y-1">
              ...
              <p className="font-heading font-bold text-sm text-white">{t('hero.trust.cnrcVal', { ns: 'offers' })}</p>
            </div>
            <div className="space-y-1">
              <span className="text-xs font-heading font-semibold text-[#8EDB68] block">{t('hero.trust.location', { ns: 'offers' })}</span>
              <p className="font-heading font-bold text-sm text-white">{t('hero.trust.locationVal', { ns: 'offers' })}</p>
            </div>
            <div className="space-y-1">
              <span className="text-xs font-heading font-semibold text-[#8EDB68] block">{t('hero.trust.services', { ns: 'offers' })}</span>
              <p className="font-heading font-bold text-sm text-white">{t('hero.trust.servicesVal', { ns: 'offers' })}</p>
            </div>
            <div className="space-y-1">
              <span className="text-xs font-heading font-semibold text-[#8EDB68] block">{t('hero.trust.remote', { ns: 'offers' })}</span>
              <p className="font-heading font-bold text-sm text-white">{t('hero.trust.remoteVal', { ns: 'offers' })}</p>
            </div>
          </div>
        ...
        <section id="section-domiciliation" className="scroll-mt-32 space-y-10">
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 pb-6 border-b border-[#E2DFD5]">
            <div className="max-w-3xl space-y-2">
              <div className="inline-flex items-center gap-2 text-xs font-heading font-bold text-[#04846E] bg-[#04846E]/10 px-3 py-1 rounded-full">
                <Building2 className="w-3.5 h-3.5" />
                <span>{t('sections.s1.tag', { ns: 'offers' })}</span>
              </div>
              <h2 className="font-heading text-3xl sm:text-4xl font-extrabold text-[#123C32] tracking-tight">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-stretch">
            ...
            <div className="relative rounded-3xl bg-white border border-[#E2DFD5] p-7 sm:p-8 flex flex-col justify-between shadow-sm hover:shadow-lg transition-all duration-300">
              <div className="space-y-6">
                ...
                <div className="flex items-center justify-between gap-2">
                  <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#F5F3EA] text-xs font-heading font-bold text-[#5E6D68]">
                    <Layers className="w-3 h-3 text-[#5E6D68]" />
                    <span>{t('sections.s1.silver.tag', { ns: 'offers' })}</span>
                  </div>
                  <span className="text-xs font-poppins font-medium text-[#5E6D68]">{t('sections.s1.silver.billing', { ns: 'offers' })}</span>
                </div>
                ...
                <div className="p-4 rounded-2xl bg-[#F5F3EA] border border-[#E2DFD5]/60">
                  ...
                  <div className="flex items-baseline gap-1.5 mt-0.5">
                    <span className="font-heading text-3xl font-extrabold text-[#123C32]">{t('sections.s1.silver.price', { ns: 'offers' })}</span>
                ...
                <div className="space-y-3 pt-2">
                  <span className="text-xs font-heading font-bold uppercase tracking-wider text-[#123C32] block">
              ...
              <div className="pt-8 mt-6 border-t border-[#E2DFD5]">
                <button
                  ...
                  className="w-full farmio-btn-outline px-5 py-3 text-xs font-heading font-bold uppercase tracking-wider cursor-pointer flex items-center justify-center gap-2 active:scale-[0.98] transition-transform"
                >
            ...
            <div className="relative rounded-3xl bg-[#123C32] text-white p-7 sm:p-8 flex flex-col justify-between shadow-2xl border-2 border-[#8EDB68] md:-translate-y-2">
              ...
              {/* Popular Badge */}
              <div className="absolute -top-3.5 left-1/2 -translate-x-1/2 px-4 py-1 rounded-full bg-[#8EDB68] text-[#123C32] font-heading text-[11px] font-extrabold uppercase tracking-wider shadow-md flex items-center gap-1.5 whitespace-nowrap">
              ...
              <div className="space-y-6 pt-2">
                ...
                {/* Header */}
                <div className="flex items-center justify-between gap-2">
                  <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/15 text-xs font-heading font-bold text-[#8EDB68]">
                    <Award className="w-3.5 h-3.5 text-[#8EDB68]" />
                    <span>{t('sections.s1.business.tag', { ns: 'offers' })}</span>
                  </div>
                  <span className="text-xs font-poppins font-medium text-white/80">{t('sections.s1.business.billing', { ns: 'offers' })}</span>
                </div>
                ...
                <div className="p-4 rounded-2xl bg-white/10 border border-white/15">
                  ...
                  <div className="flex items-baseline gap-1.5 mt-0.5">
                    <span className="font-heading text-3xl font-extrabold text-[#8EDB68]">{t('sections.s1.business.price', { ns: 'offers' })}</span>
                ...
                {/* Features */}
                <div className="space-y-3 pt-2">
                  <span className="text-xs font-heading font-bold uppercase tracking-wider text-[#8EDB68] block">
              ...
              <div className="pt-8 mt-6 border-t border-white/15">
                <button
                  ...
                  className="w-full farmio-btn-accent px-5 py-3.5 text-xs font-heading font-bold uppercase tracking-wider cursor-pointer flex items-center justify-center gap-2 shadow-lg active:scale-[0.98] transition-transform"
                >
            ...
            <div className="relative rounded-3xl bg-white border border-[#E2DFD5] p-7 sm:p-8 flex flex-col justify-between shadow-sm hover:shadow-lg transition-all duration-300">
              <div className="space-y-6">
                ...
                <div className="flex items-center justify-between gap-2">
                  ...
                  <span className="text-xs font-poppins font-medium text-[#5E6D68]">{t('sections.s1.gold.billing', { ns: 'offers' })}</span>
                </div>
                ...
                <div className="p-4 rounded-2xl bg-[#F5F3EA] border border-[#E2DFD5]/60">
                  ...
                  <div className="flex items-baseline gap-1.5 mt-0.5">
                    <span className="font-heading text-3xl font-extrabold text-[#123C32]">{t('sections.s1.gold.price', { ns: 'offers' })}</span>
        ...
        <section id="section-coworking" className="scroll-mt-32 space-y-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-stretch">
            ...
            <div className="relative rounded-3xl bg-white border border-[#E2DFD5] p-7 sm:p-8 flex flex-col justify-between shadow-sm hover:shadow-xl hover:border-[#04846E]/40 transition-all duration-300">
              <div className="space-y-6">
                ...
                <div className="flex items-center justify-between gap-2">
                  ...
                  <span className="px-3 py-1 rounded-full bg-[#F5F3EA] text-[11px] font-heading font-bold text-[#04846E]">
                ...
                <div className="p-4 rounded-2xl bg-[#FAF9F5] border border-[#E2DFD5]/80">
                  ...
                  <div className="flex items-baseline gap-1.5 mt-0.5">
                    <span className="font-heading text-3xl font-extrabold text-[#123C32]">{t('sections.s2.coworking.price', { ns: 'offers' })}</span>
            ...
            <div className="relative rounded-3xl bg-white border-2 border-[#04846E] p-7 sm:p-8 flex flex-col justify-between shadow-md hover:shadow-xl transition-all duration-300">
              ...
              <div className="absolute -top-3 left-6 px-3.5 py-0.5 rounded-full bg-[#04846E] text-white font-heading text-[10px] font-extrabold uppercase tracking-wider">
              ...
              <div className="space-y-6 pt-1">
                ...
                <div className="flex items-center justify-between gap-2">
                  ...
                  <span className="px-3 py-1 rounded-full bg-[#04846E]/10 text-[11px] font-heading font-bold text-[#04846E]">
                ...
                <div className="p-4 rounded-2xl bg-[#FAF9F5] border border-[#04846E]/20">
                  ...
                  <div className="flex items-baseline gap-1.5 mt-0.5">
                    <span className="font-heading text-3xl font-extrabold text-[#04846E]">{t('sections.s2.office.price', { ns: 'offers' })}</span>
              ...
              <div className="pt-8 mt-6 border-t border-[#E2DFD5]">
                <button
                  ...
                  className="w-full farmio-btn-accent px-5 py-3.5 text-xs font-heading font-bold uppercase tracking-wider cursor-pointer flex items-center justify-center gap-2 shadow-sm active:scale-[0.98] transition-transform"
                >
            ...
            <div className="relative rounded-3xl bg-white border border-[#E2DFD5] p-7 sm:p-8 flex flex-col justify-between shadow-sm hover:shadow-xl hover:border-[#04846E]/40 transition-all duration-300">
              <div className="space-y-6">
                ...
                <div className="p-4 rounded-2xl bg-[#FAF9F5] border border-[#E2DFD5]/80">
                  ...
                  <div className="flex items-baseline gap-1.5 mt-0.5">
                    <span className="font-heading text-3xl font-extrabold text-[#123C32]">{t('sections.s2.meeting.price', { ns: 'offers' })}</span>
              ...
              <div className="space-y-6">
                ...
                <div className="p-4 rounded-2xl bg-[#FAF9F5] border border-[#E2DFD5]/80 flex items-center justify-between">
                  <div>
                    ...
                    <span className="font-heading text-2xl font-extrabold text-[#123C32]">{t('sections.s3.creation.price', { ns: 'offers' })}</span>
                  </div>
                  <span className="text-[11px] font-poppins font-semibold bg-[#123C32] text-white px-3 py-1 rounded-full">
              ...
              <div className="space-y-6">
                ...
                <div className="p-4 rounded-2xl bg-[#FAF9F5] border border-[#E2DFD5]/80 flex items-center justify-between">
                  <div>
                    ...
                    <span className="font-heading text-2xl font-extrabold text-[#123C32]">{t('sections.s3.advisory.price', { ns: 'offers' })}</span>
                  </div>
                  <span className="text-[11px] font-poppins font-semibold bg-[#123C32] text-white px-3 py-1 rounded-full">
              ...
              <div className="space-y-6">
                ...
                <div className="p-4 rounded-2xl bg-[#FAF9F5] border border-[#E2DFD5]/80 flex items-center justify-between">
                  <div>
                    ...
                    <span className="font-heading text-2xl font-extrabold text-[#123C32]">{t('sections.s3.digital.price', { ns: 'offers' })}</span>
                  </div>
                  <span className="text-[11px] font-poppins font-semibold bg-[#123C32] text-white px-3 py-1 rounded-full">
            ...
            <div className="relative z-10 max-w-3xl space-y-6">
              ...
              <div className="pt-4 flex flex-wrap items-center gap-4">
                <button
                  ...
                  className="farmio-btn-accent px-8 py-4 text-xs sm:text-sm font-heading font-bold inline-flex items-center gap-2.5 shadow-xl cursor-pointer active:scale-[0.98] transition-all"
                >
                ...
                <a
                  ...
                  className="farmio-btn-outline-white px-8 py-4 text-xs sm:text-sm font-heading font-bold inline-flex items-center gap-2 cursor-pointer active:scale-[0.98] transition-all"
                >
                  <PhoneCall className="w-4 h-4 text-[#8EDB68]" />
                  <span>+213 670 13 23 53</span>
                </a>
              </div>
